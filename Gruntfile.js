...
module.exports = function(grunt) {
    ...
    if ( grunt.file.exists(config_file_name) ) {
        ...
        config.js_files = grunt.file.expand(['src/javascript/utils/*.js','src/javascript/lib/moment.min.js','src/javascript/lib/moment-range.js','src/javascript/lib/moment-timezone-with-data-2010-2020.min.js','src/javascript/lib/pi-scope-change-chart.js','src/javascript/*.js']);
